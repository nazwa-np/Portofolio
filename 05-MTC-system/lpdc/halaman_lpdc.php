...
$title = "Dashboard";
require_once "template_lpdc/header.php";
require_once "template_lpdc/navbar.php";
require_once "template_lpdc/sidebar.php";
...
<div id="layoutSidenav_content">
  ...
  <div class="card-body">
    ...
    <a href="<?= $main_url ?>/monitoring/tes.php" class="btn btn-dark">View Details</a>
  </div>
  <div class="card-body">
  ...
  <div class="card-body">
    ...
    <a href="<?= $main_url ?>/monitoring/section.php" class="btn btn-dark">View Details</a>
                        ...
                        <div class="row">
<?php
require_once "template_lpdc/footer.php";
