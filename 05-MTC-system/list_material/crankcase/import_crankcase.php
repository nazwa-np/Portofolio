    ...
    if ($handle !== FALSE) {
        ...
        while (($data = fgetcsv($handle, 5000, ",")) !== FALSE) {
            ...
            if (!empty($material_number)) {
                ...
                $query = "INSERT INTO list_crankcase (tipe_material, material_number, material_desc, unit, qty, price, std_using, kuota_mps, actual_prod, vol_prod, plan) 
...
if(isset($_POST['submit'])) {
    ...
    if($result) {
        ...
        echo '<script>alert("Data berhasil di-submit!"); window.location.href = "list_crankcase.php";</script>';
    } else {
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4 justify-content-center">
            <h1 class="mt-4 mb-5">List Material Crank Case</h1>
