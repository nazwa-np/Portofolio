    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        <div class="form-inline mr-auto">
          ...
          <h4 class="font-weight-bold mt-2"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h4>
        </div>
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu mt-3">
            <li class="menu-header">Main Menu</li>
                        ...
                        <li class="<?php echo $__env->yieldContent('generate_jadwal', ''); ?>">
...
<?php /**PATH C:\laragon\www\Management_Gereja\resources\views/layouts/index.blade.php ENDPATH**/ ?>