<?php $__env->startSection('menu-musik-personil', 'active'); ?>
  ...
  <div class="main-wrapper main-wrapper-1">
                ...
                <div class="tab-pane fade show active" id="alat" role="tabpanel">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped" id="table-alat">
                      ...
                      <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $alatMusik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $alat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                          <td class="text-center"><?php echo e($index + 1); ?></td>
                          <td class="text-center"><?php echo e($alat->nama_alat); ?></td>
                          <td class="text-center">
                            <button class="btn btn-warning btn-sm btn-edit-alat" 
                                data-id="<?php echo e($alat->id_alat); ?>" 
                                data-nama="<?php echo e($alat->nama_alat); ?>"><i class="fas fa-edit"></i> Edit</button>
                            <form action="<?php echo e(route('alat.destroy', $alat->id_alat)); ?>" method="POST" class="d-inline">
                              <?php echo csrf_field(); ?>
                ...
                <div class="tab-pane fade" id="personil" role="tabpanel">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped" id="table-personil">
                      ...
                      <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $pemainMusik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pemain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                          <td class="text-center"><?php echo e($index + 1); ?></td>
                          <td class="text-center"><?php echo e($pemain->nama_pemain); ?></td>
                          <td class="text-center"><?php echo e($pemain->gender === 'L' ? 'Laki-laki' : 'Perempuan'); ?></td>
                          <td class="text-center">
                            <?php if($pemain->foto): ?>
                              <img src="<?php echo e(asset('storage/'.$pemain->foto)); ?>" alt="Foto" class="personil-photo">
                            <?php else: ?>
                              <img src="/assets/img/usernopp.png" alt="Foto" class="personil-photo">
                            <?php endif; ?>
                          </td>
                          <td class="text-center">
                            <?php $__currentLoopData = $pemain->alat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php echo e($a->nama_alat); ?><?php echo e(!$loop->last ? ', ' : ''); ?>

                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </td>
                          <td class="text-center">
                            <button class="btn btn-warning btn-sm btn-edit-personil" 
                                data-id="<?php echo e($pemain->id_pemain); ?>" 
                                data-nama="<?php echo e($pemain->nama_pemain); ?>"
                                data-gender="<?php echo e($pemain->gender); ?>"
                                data-alat="<?php echo e($pemain->alat->pluck('id_alat')); ?>"
                                data-foto="<?php echo e($pemain->foto); ?>"><i class="fas fa-edit"></i> Edit</button>
                            <form action="<?php echo e(route('pemain.destroy', $pemain->id_pemain)); ?>" method="POST" class="d-inline">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('DELETE'); ?>
    ...
    <div class="modal fade" id="modalTambahAlat" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          <form action="<?php echo e(route('alat.store')); ?>" method="POST"><?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="modalTambahPersonil" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
            <form action="<?php echo e(route('pemain.store')); ?>" method="POST" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 posisi-item">
                        ...
                        <?php $__currentLoopData = $alatMusik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($alat->id_alat); ?>"><?php echo e($alat->nama_alat); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
$(document).ready(function() {
    ...
    const alatMusikList = <?php echo json_encode($alatMusik, 15, 512) ?>;
...
</html><?php /**PATH C:\laragon\www\Management_Gereja\resources\views/musikpersonil.blade.php ENDPATH**/ ?>