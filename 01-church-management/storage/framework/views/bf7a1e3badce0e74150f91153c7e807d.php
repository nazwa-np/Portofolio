<?php $__env->startSection('title', 'Generate Jadwal Ibadah'); ?>
<?php $__env->startSection('page-title', 'Generate Jadwal Ibadah dengan Algoritma Genetika'); ?>
...
<style>
    .stats-card {
        ...
        padding: 20px;
        margin-bottom: 20px;
        display: <?php echo e(session('generation_stats') ? 'block' : 'none'); ?>;
    }
    .stat-item {
        display: flex;
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="generate-form">
                    <form id="generateForm" action="<?php echo e(route('generate.jadwal')); ?>" method="POST" class="d-flex align-items-center" style="gap: 15px;">
                        <?php echo csrf_field(); ?>
                        <select name="periode" id="periode" class="form-control form-control-lg" required style="min-width: 250px;">
                            <option value="">-- Pilih Periode --</option>
                            <?php $__currentLoopData = $periodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periode_layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($periode_layanan->nama_periode); ?>"
                                    <?php echo e($selectedPeriode == $periode_layanan->nama_periode ? 'selected' : ''); ?>>
                                    <?php echo e($periode_layanan->nama_periode); ?>

                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <button type="submit" class="btn btn-primary btn-generate" id="generateBtn">
                            <?php echo e($selectedPeriode && session('generated_jadwal') ? 'Generate' : 'Generate'); ?>

                        </button>
                    </form>

                    <?php if(!$selectedPeriode && !session('generated_jadwal')): ?>
                        <div class="alert alert-info mt-3">
                            <i class="fas fa-info-circle"></i>
                            Pilih periode layanan terlebih dahulu lalu klik tombol Generate untuk melihat preview jadwal.
                        </div>
                    <?php elseif($selectedPeriode && !session('generated_jadwal')): ?>
                        <div class="alert alert-warning mt-3">
                            <i class="fas fa-exclamation-triangle"></i>
                            Periode <strong><?php echo e($periodes->firstWhere('nama_periode', $selectedPeriode)->nama_periode ?? 'Unknown'); ?></strong> sudah dipilih. 
                ...
                <?php if(session('generated_jadwal') && $selectedPeriode): ?>
                    <?php 
                    ...
                    <div class="preview-table" id="previewContainer">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5><i class="fas fa-eye text-info"></i> Preview Jadwal: <?php echo e($currentPeriode->nama_periode ?? 'Unknown'); ?></h5>
                            <div>
                                <form action="<?php echo e(route('generate.jadwal')); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('generate.jadwal.save')); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="periode" value="<?php echo e($selectedPeriode); ?>">
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i>
                            Ini adalah preview jadwal hasil generate untuk periode <strong><?php echo e($currentPeriode->nama_periode ?? 'Unknown'); ?></strong>. 
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover text-center align-middle">
                                ...
                                <tbody>
                                    <?php $no = 1; ?>
                                    <?php $__currentLoopData = $jadwalPreview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ibadah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <?php $__currentLoopData = $ibadah['alat_assignments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <?php if($index == 0): ?>
                                                    <td rowspan="<?php echo e($rowspan); ?>"><?php echo e($no++); ?></td>
                                                    <td rowspan="<?php echo e($rowspan); ?>" class="font-weight-bold"><?php echo e($ibadah['nama_ibadah']); ?></td>
                                                    <td rowspan="<?php echo e($rowspan); ?>"><i class="fas fa-calendar-alt text-primary"></i> <?php echo e($tanggal); ?></td>
                                                    <td rowspan="<?php echo e($rowspan); ?>"><i class="fas fa-clock text-success"></i> <?php echo e($jam); ?></td>
                                                <?php endif; ?>
                                                <td><?php echo e($assignment['nama_pemain']); ?></td>
                                                <td><?php echo e($assignment['nama_alat']); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex align-items-center">
                    <a href="<?php echo e(route('jadwal.export', ['periode' => $selectedPeriode])); ?>" 
            ...
            <div class="card-body">
                <?php if($jadwalTersimpan->isEmpty()): ?>
                ...
                <?php else: ?>
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover" id="jadwalSavedTable">
                            ...
                            <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKey => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <?php if($idx == 0): ?>
                                            <td rowspan="<?php echo e($rowspan); ?>"><?php echo e($rowNumber++); ?></td>
                                            <td rowspan="<?php echo e($rowspan); ?>"><span class="badge badge-secondary"><?php echo e($j->nama_periode); ?></span></td>
                                            <td rowspan="<?php echo e($rowspan); ?>" class="font-weight-bold"><?php echo e($namaIbadah); ?></td>
                                            <td rowspan="<?php echo e($rowspan); ?>"><i class="fas fa-calendar-alt text-primary"></i> <?php echo e($tanggal); ?></td>
                                            <td rowspan="<?php echo e($rowspan); ?>"><i class="fas fa-clock text-success"></i> <?php echo e($jam); ?></td>
                                        <?php endif; ?>
                                        <td><?php echo e($j->nama_pemain); ?></td>
                                        <td><?php echo e($j->nama_alat ?: 'Tidak ada'); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
...
$(document).ready(function() {
    ...
    var selectedPeriode = <?php echo json_encode($selectedPeriode, 15, 512) ?>;
    var jadwalTersimpanCount = <?php echo e($jadwalTersimpan->count()); ?>;
    var hasGeneratedJadwal = <?php echo e(session()->has('generated_jadwal') ? 'true' : 'false'); ?>;
    var hasGeneratedJadwalLastPeriod = <?php echo e(session()->has('last_generated_periode') ? 'true' : 'false'); ?>;
    var lastGeneratedPeriode = <?php echo json_encode(session('last_generated_periode'), 15, 512) ?>;
    ...
    if (selectedPeriode && jadwalTersimpanCount === 0 && hasGeneratedJadwalLastPeriod && lastGeneratedPeriode !== selectedPeriode) {
        Swal.fire({
            ...
            didClose: () => {
                ...
                $('<form>', {
                    'method': 'POST',
                    'action': '<?php echo e(route("generate.jadwal")); ?>'
                })
                .append($('<input>', {
                    'type': 'hidden',
                    'name': '_token',
    ...
    $('#simpanJadwalBtn').on('click', function(e) {
        e.preventDefault();
        var btn = $(this);
        var periodeName = '<?php echo e($selectedPeriode && isset($currentPeriode) ? $currentPeriode->nama_periode : "jadwal ini"); ?>';
    ...
    $('.btn-regenerate').on('click', function(e) {
        ...
        var periodeName = '<?php echo e($selectedPeriode && isset($currentPeriode) ? $currentPeriode->nama_periode : ""); ?>';
        ...
        html: `
            <div class="text-center">
                <div class="alert alert-success">
                    ...
                    <h5><?php echo e($periodes->firstWhere('nama_periode', $selectedPeriode)->nama_periode ?? 'Unknown'); ?></h5>
                </div>
    ...
    $('#periode').on('change', function() {
        ...
        if (selectedValue) {
            ...
            setTimeout(() => {
                window.location.href = '<?php echo e(route("generate.jadwal")); ?>' + '?periode=' + selectedValue;
            }, 1000);
        }
    });
    ...
    <?php if($jadwalTersimpan->isEmpty() && !session('generated_jadwal')): ?>
    setTimeout(function() {
    ...
    Swal.fire({
        ...
        html: `
            <div class="text-center">
                ...
                <p>Jadwal untuk periode <strong><?php echo e(session('saved_periode')); ?></strong> telah tersimpan ke database.</p>
                <div class="alert alert-success">
                    <i class="fas fa-database"></i>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Management_Gereja\resources\views/generate_jadwal.blade.php ENDPATH**/ ?>