                                ...
                                <tbody>
                                    @foreach($data_ti as $i => $itm)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('adminti.form_update', $itm->id) }}" class="btn btn-sm btn-warning me-1">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('adminti.destroy', $itm->id) }}" method="POST" class="d-inline form-delete">
                                                    @csrf
                                                    @method('DELETE')
