            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('superadmin.index') ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text">Edit Data User</span>
                     </a>                     
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ request()->routeIs('superadmin.ruang') ? 'active' : '' }}"
                     href="{{ route('superadmin.ruangIndex') }}">
                    <i class="fas fa-save me-2"></i>
                    <span class="nav-link-text">Data Ruangan</span>
                  </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('superadmin.jam') ? 'active' : '' }}"
                       href="{{ route('superadmin.jam') }}">
                      <i class="fas fa-save me-2"></i>
                      <span class="nav-link-text">Data Waktu Perkuliahan </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('superadmin.kelasIndex') ? 'active' : '' }}"
                       href="{{ route('superadmin.kelasIndex') }}">
                      <i class="fas fa-save me-2"></i>
                      <span class="nav-link-text">Data Kelas </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('superadmin.constraints.index') ? 'active' : '' }}"
                       href="{{ route('superadmin.constraints.index') }}">
                      <i class="fas fa-save me-2"></i>
                      <span class="nav-link-text">Data Constraints </span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <script>
            ...
            // Alert handling for session messages
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "{{ route('superadmin.save_datati') }}";
                    }
                });
                @endif
