    ...
    <div class="col-12">
      <div class="card mb-4 shadow-sm">
        <div class="card-header text-center">
          <h5 class="mb-0" style="font-size: 1.9rem;">Constraints Ruangan</h5>
        </div>
        <div class="card-body px-3 py-3">
          <div class="mb-3 text-end">
            <a href="{{ route('superadmin.constraints.ruangan_insert') }}" class="btn btn-primary">
            ...
            <div class="table-responsive">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('superadmin.constraints.ruangan_delete', $itm->id) }}"
                              method="POST"
