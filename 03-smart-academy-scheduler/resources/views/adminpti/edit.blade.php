                                ...
                                <tbody>
                                    @foreach($data_pti as $i => $itm)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('adminpti.form_update', $itm->id) }}" class="btn btn-sm btn-warning me-1">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('adminpti.destroy', $itm->id) }}" method="POST" class="d-inline form-delete">
                                                    @csrf
                                                    @method('DELETE')
