...
@section('page-title', 'Data Pendidikan Teknik Informatika')
...
<div class="container-fluid py-4">
  <div class="row">
    <div class="col-12">
      <form id="form-pilih" action="{{ route('adminpti.verifikasi-massal') }}" method="POST">
        @csrf
        <div class="card mb-4 shadow-sm">
          <div class="card-header bg-white d-flex justify-content-center align-items-center">
            <h5 class="mb-0" style="font-size: 1.8rem;">Data Prodi PTI</h5>
          </div>
